...
msg-choose-device = Choose a block device or image for UDPBD first.
msg-udpbd-server-missing = udpbd-server not found. Install it and make sure it is in your PATH.
