...
msg-choose-device = Escolha primeiro um block device ou imagem para o UDPBD.
msg-udpbd-server-missing = udpbd-server não encontrado. Instale-o e garanta que esteja no PATH.
